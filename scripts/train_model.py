import os
import sys
# Ensure project root is on sys.path so sibling 'src' package can be imported
...
file_path = r'Autism-Spectrum-Disorder-Detection-and-Analysis-master\data\autism_data.csv'
